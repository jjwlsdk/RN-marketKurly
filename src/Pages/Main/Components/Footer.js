  ...
  return (
    <Container>
      ...
      <Customer>
        ...
        <TelTime>365고객센터<Bar> I </Bar>오전 7시 - 오후 7시</TelTime>
      </Customer>
      <KakaoTalk>카카오톡 <Tag>@마켓컬리 </Tag>친구 추가하고 소식과 혜택을 받아보세요.</KakaoTalk>
      <Company>
        ...
        팩스 : 070-7500-6098 <Bar> I </Bar> 이메일 : <Tag>help@kurlycorp.com</Tag>
      </Company>
      <Certification>
        <CertWrap>
          <CertImage source={{uri : "https://res.kurly.com/pc/ico/2001/logo_isms.png"}}/>
          <CertText>
        ...
        <CertWrap>
          <CertImage source={{uri : "https://res.kurly.com/pc/ico/2001/logo_eprivacyplus.png"}}/>
          <CertText>
            개인정보보호 우수 웹사이트 ·{"\n"}
...
const categoryData = ["컬리소개", "이용안내", "배송안내", "자주하는 질문", "공지사항", "인재채용", "이용약관", "개인정보처리방침"]
const snsIcon = ["https://res.kurly.com/mobile/service/common/1903/ico_instagram.png", "https://res.kurly.com/mobile/service/common/1903/ico_fb.png", "https://res.kurly.com/mobile/service/common/1903/ico_blog.png", "https://res.kurly.com/mobile/service/common/1903/ico_naverpost.png?v=1", "https://res.kurly.com/mobile/service/common/1903/ico_youtube.png"]